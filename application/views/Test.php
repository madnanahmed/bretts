...
<section class="properties">
    <div class="container">
        ...
        <div class="row">
            ...
            //                                    ?>
            <!--                                </a>-->
            <!--                                <a href="--><?//= base_url('property_view/property/').$value->id ?><!--" class="propertyImgLink"><img class="propertyImg" src="--><?//= base_url('assets/images/uploads/property/home3.jpg')?><!--" alt="" /></a>-->
