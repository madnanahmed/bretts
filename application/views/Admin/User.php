				...
				<tr id="row_<?= $i; ?>">
					...
					<td>
						<small class="text-muted">
							<i class="glyphicon glyphicon-time"></i> <span class="icon-text"><?= $time . ' ago'; ?></span>
						</small>
					</td>
					...
					<td class="text-xs-center">
						<div class="dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right text-right">
								<a class="dropdown-item" href="<?= base_url('admin/edit_user/').$value->id; ?>" title="Edit user">Edit <i class="glyphicon glyphicon-pencil text-success"></i></a>
								<a class="dropdown-item" href="#" onclick="deactive_user('<?= $value->id ?>', '<?= $i; ?>')" title="Inactive user">Inactive <i class="glyphicon glyphicon-trash text-danger"></i></a>
							</div>
						</div>
					</td>
				</tr>
