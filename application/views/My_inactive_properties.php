...
<section class="genericSection">
    ...
    <div class="col-md-10">
        ...
        <table class="myProperties">
            ...
            <?php
            if($data['inactive_property'] == 0){
                echo '<tr class="text-red">
                        <td align="" colspan="7"><h4>Inactive property not found! </h4></td>
                    </tr>';
            }
            ...
            <tr>
                ...
                <td class="myPropertyActions">
                    ...
                    <span  id="<?= $value->id?>" onclick="delete_property(this.id)"><a href="javascript:void(0)" class="text-red"><img class="icon de_<?= $value->id?>" src="<?= base_url('assets/images/icon-cross.png') ?>" alt="" />DELETE</a></span>
                    <span id="<?= $value->id?>" onclick="active_property(this.id)"><a href="javascript:void(0)"><img class="icon act_<?= $value->id?>" src="<?= base_url('assets/images/icon-check.png') ?>" alt="" />Activate</a></span>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
